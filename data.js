...
const ELEMENTS = {
  ...
  cv:{n:"CV",e:"📑",f:"One page, generously formatted."},
  candidate:{n:"Candidate",e:"🙋",f:"A CV the recruiter liked."},
...
const RAW = [
  ...
  ["employee","meeting","email"],
  ["hr","employee","onboarding"],
  ["hr","onboarding","intern"],
  ["manager","okr","deadline"],
